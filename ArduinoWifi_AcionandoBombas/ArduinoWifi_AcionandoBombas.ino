    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == '\n')
        {
          ...
          client.println("<link rel='stylesheet' type='text/css' href='automacao_residencial.css'/>");
          client.println("script type='text/javascript' src='automacao_residencial.js'></script>");
          client.println("</head>");
          client.println("<body>");
          client.println("<div id='wrapper'><img title='RoboticParts' src='Testes.png' width='400' height='150'/> <br/>");
          client.println();
          client.println();
